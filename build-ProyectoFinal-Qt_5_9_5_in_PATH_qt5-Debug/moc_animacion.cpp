...
#include "../ProyectoFinal/animacion.h"
...
struct qt_meta_stringdata_Animacion_t {
    QByteArrayData data[3];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Animacion_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Animacion_t qt_meta_stringdata_Animacion = {
    {
QT_MOC_LITERAL(0, 0, 9), // "Animacion"
...
const QMetaObject Animacion::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Animacion.data,
      qt_meta_data_Animacion,  qt_static_metacall, nullptr, nullptr}
};
...
void *Animacion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Animacion.stringdata0))
